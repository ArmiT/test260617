	...
	<div>
		<form  method="POST" enctype="multipart/form-data">
			<div id="std">
				...
				<div id="clmnT"><input type='text' name='login' value="" size="30" placeholder="администратора" required pattern="^[а-яА-ЯёЁa-zA-Z0-9_.]{1,255}$" maxlength="255"></div>
			</div>
			<div id="std">
				<div id="clmn">Пароль:</div>
				<div id="clmnT"><input type='password' name='password'  size="30" value="" placeholder="администратора" required maxlength="255"></div>
			</div>
			<div id="std">
				<div id="clmn"></div>
